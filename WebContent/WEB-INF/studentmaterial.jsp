...
<div class="container">
<center><h2>Section Materials List</h2></center>
<table id="myTable" class="table table-striped" >  
        ...
        <c:forEach var="material" items="${materiallist}">
		  <tr>
	     	 	...
	     	 	<td><a class="btn btn-success" href="/LMS/student/downloadFile?fileName=${material.filename}">ViewFile</a>	
	      </tr>
		</c:forEach>
        </tbody>  
</table> 
 <a class="btn btn-primary" href="<%=path %>/student/viewtimetable?className=${className}&email=${email}&Name=${Name}" style="float:right">Back</a>
</div> 
<script>
